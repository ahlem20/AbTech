...
const Dashboard = ({ storeName = "Store 2", username = "user" }) => {
  ...
  const handleButtonClick = (path) => {
    ...
    switch (path) {
      ...
      case "/view-statistics":
        ...
        break;
      case "/oilChangeModal":
        title = "Add Oil Change Transaction";
        content = <OilChangeModal closePopup={closePopup} />;
        break;
      case "/manage-users":
        title = "Manage Users";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      ...
      <div className="w-full max-w-4xl mb-12 text-center">
        ...
        <Link to="/main"> <div className="text-5xl  text-gray-800"><IoMdArrowRoundBack /></div></Link>
      </div>
